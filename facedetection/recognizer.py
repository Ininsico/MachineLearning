...
# Config
# ---------------------------------------------------------------------------
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://USER:PASSWORD@cluster0.xgjup6a.mongodb.net/campussecuirty")  # set MONGO_URI via environment, do not hardcode credentials
